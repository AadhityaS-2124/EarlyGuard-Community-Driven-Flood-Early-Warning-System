...
let reports = [];
let alerts = [];
let fcmTokens = []; // Store FCM tokens for push notifications (mock)
let phoneNumbers = []; // Store Mail ids for Mail alerts (mock)
...
app.post('/api/reports', async (req, res) => {
  try {
    ...
    if (riskLevel === 'medium' || riskLevel === 'high') {
      ...
      console.log(`New alert created: ${alertTitle}`);
    }
...
// Register FCM token for push notifications (mock)
...
// Register Mail id for Mail alerts (mock)
